 ...
 */
export type FluentIconComponent = React.ComponentType<
...
export const RibbonToolbarAction: React.FC<RibbonToolbarActionProps> = ({
  ...
  const handleClick = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      console.error(
        `Error in RibbonToolbarAction onClick handler for ${label || "unlabeled action"}:`,
        error,
      );
    }
  };
  ...
  return (
    <Tooltip content={displayTooltip} relationship="label">
      <ToolbarButton
