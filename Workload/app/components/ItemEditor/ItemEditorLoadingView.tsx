 ...
 */
export const ItemEditorLoadingView = ({
  message,
  icon,
}: ItemEditorLoadingViewProps) => {
  ...
  const renderIcon = () => {
    ...
    return <div className="item-editor-loading-icon">{displayIcon}</div>;
  };

  return (
    <div
      className="item-editor-loading-container"
      role="progressbar"
      aria-label={message}
      aria-busy="true"
