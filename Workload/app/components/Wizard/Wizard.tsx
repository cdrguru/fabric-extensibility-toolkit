...
export function WizardControl({
  ...
  const getStepStatus = (stepIndex: number) => {
    if (completedSteps.has(steps[stepIndex].id) || stepIndex < currentStepIndex)
      return "completed";
  ...
  const goToStep = async (stepId: string) => {
    ...
    const canNavigate =
      targetIndex <= currentStepIndex || completedSteps.has(stepId);
    ...
    <div className={`wizard-control ${className}`.trim()}>
      ...
      <div className="wizard-control__main">
              ...
              return (
                <div key={step.id}>
                  ...
                  >
                    ...
                    <div
                      className={`wizard-control__step-circle wizard-control__step-circle--${status}`}
                    >
                      {status === "completed" ? (
        ...
        <div className="wizard-control__content-panel" role="main">
          {currentStep && <currentStep.component {...stepProps} />}
        </div>
      </div>
