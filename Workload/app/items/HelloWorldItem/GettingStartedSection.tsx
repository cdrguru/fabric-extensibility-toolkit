      ...
      <div className="hello-world-next">
        <div className="hello-world-section-header">
          ...
          <p className="hello-world-section-subtitle">
            {t(
              ...
              "Follow the steps below to save your Fabric item.",
            )}
          </p>
        </div>
          ...
          <ol className="hello-world-next-list">
            <li className="hello-world-next-item">
              {t(
                ...
                "Change the item definition on the right.",
              )}
            </li>
            <li className="hello-world-next-item">
              {t(
                "GettingStarted_Card1_Bullet2",
                "Save the item, to store the state in Fabric.",
              )}
            </li>
          </ol>
        </div>
        ...
        <div className="hello-world-section-header">
          ...
          <p className="hello-world-section-subtitle">
            {t(
              "GettingStarted_SectionSubtitle",
              "Follow the steps below to build a new Fabric item.",
            )}
          </p>
        </div>
        <div className="hello-world-section-body">
          <ol className="hello-world-next-list">
            <li className="hello-world-next-item">
              {t(
                ...
                "Use the content on the right to learn more.",
              )}
            </li>
            <li className="hello-world-next-item">
              {t(
                "GettingStarted_Card1_Bullet4",
                "Create your own Fabric item.",
              )}
              <div className="hello-world-step-button">
                <Link
                  onClick={() =>
                    onOpenResource(
                      "https://aka.ms/fabric-item-development-guide",
                    )
                  }
                >
            ...
            <li className="hello-world-next-item">
              ...
              <div className="hello-world-step-button">
                <Link
                  onClick={() =>
                    onOpenResource(
                      "https://aka.ms/fabric-workload-publishing-guide",
                    )
                  }
                >
                  {t("GettingStarted_OpenTutorial", "Open Tutorial")}
