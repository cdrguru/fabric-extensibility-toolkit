...
export const FABRIC_BASE_SCOPES = {
  ...
  CONNECTION_READWRITE:
    "https://api.fabric.microsoft.com/Connection.ReadWrite.All",

  // External Data Shares operations
  EXTERNAL_DATA_SHARES_READ:
    "https://api.fabric.microsoft.com/Item.ExternalDataShare.All",
  EXTERNAL_DATA_SHARES_READWRITE:
    "https://api.fabric.microsoft.com/Item.ExternalDataShare.All",

  // External Data Shares Recipient operations
  EXTERNAL_DATA_SHARES_ACCEPT:
    "https://api.fabric.microsoft.com/ExternalDataShare.Accept.All",
  ...
  ONELAKE_DATA_ACCESS_SECURITY_READWRITE:
...
export const SCOPES = {
  ...
  CONNECTION_READ: [FABRIC_BASE_SCOPES.CONNECTION_READ].join(" "),
  ...
  GATEWAY: [FABRIC_BASE_SCOPES.GATEWAY_READWRITE].join(" "),

  // Gateway Client - read-only operations
  GATEWAY_READ: [FABRIC_BASE_SCOPES.GATEWAY_READ].join(" "),
};
 ...
 */
export function getScopeForMethod(
  scopePair: ScopePair,
  method: string,
): string {
