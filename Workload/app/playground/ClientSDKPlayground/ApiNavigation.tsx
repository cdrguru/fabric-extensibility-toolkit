  ...
  return (
    <span>
      ...
      <div className="section">
        ...
        <Label />
        <Label>
          BeforeNavigateAway callback has been registered to block navigation to
          a 'forbidden-url'. Clicking the below should NOT navigate away
        </Label>
        <Button
          appearance="primary"
          icon={<PanelRightExpand20Regular />}
