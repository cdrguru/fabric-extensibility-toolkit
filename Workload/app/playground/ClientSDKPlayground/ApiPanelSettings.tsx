...
import { themeToView, callThemeGet } from "../../controller/ThemeController";
...
export function ApiPanelSettings(props: TabContentProps) {
  ...
  async function onCallThemeGet() {
    ...
    callDialogOpenMsgBox(workloadClient, "Theme Configuration", themeString, [
      "OK",
    ]);
  }
    ...
    <span>
      ...
      <div className="section">
        <Switch
          ...
          onChange={(e) =>
            dispatch(setApiPanelIsLightDismiss(e.target.checked))
          }
        />
        <Button
          appearance="primary"
