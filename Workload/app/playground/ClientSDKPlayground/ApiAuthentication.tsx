...
export function ApiAuthentication({ workloadClient }: PageProps) {
  ...
  const { token, serverUrl, serverResponse, httpMethod, requestBody } =
      ...
      <Card className="card">
        ...
        <div className="card-content">
          <div className="description">
            ...
            make sure to add your AAD application configuration to your workload
            manifest or localWorkloadManifest.json under "workload" for
            dev:&#10;
            <b>
              devAADAppConfig:&#10; &emsp;&emsp;appId: your app id&#10;
              &emsp;&emsp;redirectUri: a redirect URI that returns an html
              containing close() javascript function&#10; &emsp;&emsp;audience:
              your audience
            </b>
            &#10;
          </div>
        ...
        <div className="card-content">
          <div className="field-group">
            <div className="api-authentication-field">
              <label className="api-authentication-field-label">
                Server endpoint:
              </label>
              <Input
            ...
            <div className="api-authentication-field">
              ...
              <Combobox
                ...
                onOptionSelect={(_, opt) =>
                  dispatch(setHttpMethod(opt.optionValue))
                }
              >
              ...
              <Button
                ...
                onClick={() =>
                  sendWorkloadServerRequest(
                    ...
                    httpMethod,
                    requestBody,
                  ).then((result) => dispatch(setServerResponse(result)))
                }
              >
                Call server's API
              </Button>
