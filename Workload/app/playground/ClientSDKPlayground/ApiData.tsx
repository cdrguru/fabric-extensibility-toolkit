      ...
      <div className="section">
        ...
        >
          <Input
            ...
            onChange={(e) =>
              dispatch(setDatahubDialogDescription(e.target.value))
            }
        ...
        >
          <Combobox
            ...
            onOptionSelect={(_, opt) =>
              dispatch(setDataHubMsgBoxType(opt.optionValue))
            }
          >
        ...
        <Switch
          ...
          onChange={(e) =>
            dispatch(setWorkspaceExplorerPresented(e.target.checked))
          }
        />
        <Switch
